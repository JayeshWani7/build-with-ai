...
def create_draft(
    ...
    sender: Annotated[str, 'Original sender\'s email address that will be used as reply-to'],
    subject: Annotated[str, 'Email subject, will be prefixed with Re: for replies'],
    thread_id: Annotated[Optional[str], 'Gmail thread ID for maintaining conversation threads'] = None,
    original_message_id: Annotated[Optional[str], 'Original message ID for setting reply headers'] = None
) -> str:
    """
    ...
    Args:
        ...
        thread_id: Optional[str] - Gmail thread ID for maintaining conversation threads
        original_message_id: Optional[str] - Original message ID for reply headers
    ...
    if original_message_id:
        ...
        raise ValueError('Original message is required for creating a reply draft')

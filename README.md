...
In case you do not have an existing Google Prject, create one at [https://console.cloud.google.com/projectcreate](https://console.cloud.google.com/projectcreate) with the name ```build-with-ai-workshop```
